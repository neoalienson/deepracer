...
#            print(f"s: {speed} , so: {optimals[2]}, sr: {speed_reward:.3f}, sd: {speed_diff:.3f}")
    ...
    def reward_function(self, params):
        ...
        racing_track = [
            [3.06664, 0.1, 4.0, 0.03654],
            [3.21372, 0.1, 4.0, 0.0368],
            [3.36169, 0.1, 4.0, 0.03701],
            [3.51032, 0.1, 4.0, 0.03716],
            [3.6594, 0.1, 4.0, 0.03727],
            [3.8088, 0.1, 4.0, 0.03735],
            [3.9584, 0.1, 4.0, 0.0374],
            [4.10793, 0.1, 4.0, 0.03738],
            [4.25712, 0.12, 4.0, 0.0373],
            [4.40585, 0.15, 4.0, 0.03719],
            [4.55396, 0.18, 4.0, 0.03704],
            [4.70133, 0.23, 4.0, 0.03686],
            [4.84783, 0.3, 4.0, 0.03666],
            [4.99331, 0.4, 3.93749, 0.03701],
            [5.13763, 0.5, 3.59367, 0.04027],
            [5.28066, 0.6, 3.26778, 0.04395],
            [5.42227, 0.7, 2.95403, 0.04823],
            ...
            [2.35729, 0.7, 3, 0.04732],
            [2.49419, 0.6, 3.5, 0.04421],
            [2.63406, 0.5, 4, 0.04088],
            [2.77639, 0.4, 4, 0.03762],
            [2.92074, 0.3, 4.0, 0.03621]]        
